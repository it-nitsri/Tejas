...
public class LSQEntry
{
	...
	private int mfence_dependencies = 0;

	
	
	public enum LSQEntryType {LOAD, STORE, MFENCE};
	...
	public void setmfencedeps(int count) {
		mfence_dependencies = count; 
	}

	public boolean is_issuable() {
		return mfence_dependencies == 0;
	}

	public void mfence_cleared() {
		mfence_dependencies --;
	}
        ...
        public void setValid(boolean valid) {
			...
			//if (type == LSQEntryType.MFENCE) {
			//System.out.println(type + ": setting valid to "+valid);
			//Thread.dumpStack();
			//}
        ...
        public String toString() {
                return "[(LSQEntry) " + type + " : " + addr + " : " + indexInQ + " : mfence deps ="+mfence_dependencies; 
        }
