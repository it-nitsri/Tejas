...
public class Operand implements Serializable
{
	...
	public static void preAllocateOperands() {
		...
		{
			//import emulatorinterface.translator.x86.registers.Registers;
		   	integerRegisterOperands = new Operand[emulatorinterface.translator.x86.registers.Registers.getMaxIntegerRegisters()];
                	for(int i=0; i<emulatorinterface.translator.x86.registers.Registers.getMaxIntegerRegisters(); i++) {
                	...
                	floatRegisterOperands = new Operand[emulatorinterface.translator.x86.registers.Registers.getMaxFloatRegisters()];
               	 	for(int i=0; i<emulatorinterface.translator.x86.registers.Registers.getMaxFloatRegisters(); i++) {
		...
		{
			integerRegisterOperands = new Operand[emulatorinterface.translator.arm.registers.Registers.getMaxIntegerRegisters()];
			for(int i=0; i<emulatorinterface.translator.arm.registers.Registers.getMaxIntegerRegisters(); i++) {
				integerRegisterOperands[i] = new Operand();
				integerRegisterOperands[i].type = OperandType.integerRegister;
				integerRegisterOperands[i].value = i;
			}
			...
			// Create float registers
			floatRegisterOperands = new Operand[emulatorinterface.translator.arm.registers.Registers.getMaxFloatRegisters()];
			for(int i=0; i<emulatorinterface.translator.arm.registers.Registers.getMaxFloatRegisters(); i++) {
				floatRegisterOperands[i] = new Operand();
				floatRegisterOperands[i].type = OperandType.floatRegister;
				floatRegisterOperands[i].value = i;
			}
                ...
                {
                        integerRegisterOperands = new Operand[emulatorinterface.translator.RiscV.registers.Registers.getMaxIntegerRegisters()];
                        for(int i=0; i<emulatorinterface.translator.RiscV.registers.Registers.getMaxIntegerRegisters(); i++) {
                                integerRegisterOperands[i] = new Operand();
                                integerRegisterOperands[i].type = OperandType.integerRegister;
                                integerRegisterOperands[i].value = i;
                        }
                        ...
                        // Create float registers
                        floatRegisterOperands = new Operand[emulatorinterface.translator.RiscV.registers.Registers.getMaxFloatRegisters()];
                        for(int i=0; i<emulatorinterface.translator.RiscV.registers.Registers.getMaxFloatRegisters(); i++) {
                                floatRegisterOperands[i] = new Operand();
                                floatRegisterOperands[i].type = OperandType.floatRegister;
                                floatRegisterOperands[i].value = i;
                        }
