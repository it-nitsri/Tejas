...
public class WriteBackUnitIn_MII extends SimulationElement{
		...
		while(memWbLatch.isEmpty() == false)
		{
			...
			if(ins != null)
			{
				...
				else
				{
					...
					{
						System.out.println(core.getNoOfInstructionsExecuted()/1000000 + " million done by core "+core.getCore_number() + " global clock cycle " + GlobalClock.getCurrentTime());
					}
	...
	{
	  numIntRegFileAccesses = 0;
	  numFloatRegFileAccesses = 0;
	}
