...
public class ReorderBufferEntry {
	...
	public long last_issue_tried = 0;
	public long delayed_due_to_fence = 0;
	int pos;
	...
	public String toString()
	{
		...
		sb.append("issue tried = " + last_issue_tried +", currently :" + GlobalClock.getCurrentTime()+"\n");
		boolean iniw = !(associatedIWEntry == null);
	
		sb.append("delayed_due_to_fence " + delayed_due_to_fence + ", in iw "+iniw);
		if(iniw) {
			sb.append(associatedIWEntry.toString());
		}	
		return sb.toString();
	}
