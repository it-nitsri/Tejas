...
public class ConditionalJump implements StaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
		...
		if((operand1.isImmediateOperand() || operand1.isIntegerRegisterOperand()) // Are these operand possible.
