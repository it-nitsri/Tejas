...
public class Load implements StaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
		...
		//if operand3 is not null so post indexing -->immediate or shifted reg by const
			//TODO: Have to add one more instruction for shifting post indexing
				 ...
				 operand2.isMemoryOperand() && 
				 operand3.isImmediateOperand()||operand3.isMemoryOperand())
		{
			instructionArrayList.appendInstruction(Instruction.getLoadInstruction(operand2, operand1));
		}
		...
		{
			misc.Error.invalidOperation("Load", operand1, operand2, operand3);
		}
	}
}
