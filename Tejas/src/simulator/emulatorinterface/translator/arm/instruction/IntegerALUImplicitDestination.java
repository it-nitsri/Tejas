...
public class IntegerALUImplicitDestination implements StaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
		...
		)
		{
			...
			if(operand3==null )
			{
					...
					instructionArrayList.appendInstruction(Instruction.getIntALUInstruction(operand1ValueOperand, 
							operand2ValueOperand, operand1ValueOperand));

					
			}
			else if (operand3.isImmediateOperand() || operand3.isIntegerRegisterOperand() )
			{
				Operand operand3ValueOperand;

				//get value-operand for destination
