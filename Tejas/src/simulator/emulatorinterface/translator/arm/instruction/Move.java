...
public class Move implements StaticInstructionHandler 
{
	...
	{
		//if operand1 is a register and operand2 is a register/immediate/shift?, we will use normal move operation
