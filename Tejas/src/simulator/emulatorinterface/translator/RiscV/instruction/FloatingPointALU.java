...
public class FloatingPointALU implements RiscVStaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
				...
				(operand3.isFloatRegisterOperand()|| operand3.isImmediateOperand()))
		{
			if(operand1.isMemoryOperand())
			{
				...
				instructionArrayList.appendInstruction(Instruction.getFloatingPointALU(tempFloatRegister1, operand3, operand1));
			}
			else
			{
