...
public class Store implements RiscVStaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
		...
		if((operand1.isIntegerRegisterOperand()) && 
		   (operand2.isMemoryOperand()||operand2.isImmediateOperand()||operand2.isIntegerRegisterOperand()) && operand3==null)
		{
