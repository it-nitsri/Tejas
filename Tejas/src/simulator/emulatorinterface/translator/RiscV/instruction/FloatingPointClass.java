...
public class FloatingPointClass implements RiscVStaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
		...
		if((operand1!=null && operand1.getOperandType()==OperandType.floatRegister||operand1.isIntegerRegisterOperand()) && 
		   (operand2!=null && operand2.getOperandType()==OperandType.floatRegister||operand2.isIntegerRegisterOperand()) && 
				operand3==null)
		{
