...
public class ConditionalStore implements RiscVStaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
		...
		if((operand1.isIntegerRegisterOperand()||operand1.isImmediateOperand()) && 
		   (operand2.isIntegerRegisterOperand()||operand2.isImmediateOperand()) &&
		   (operand3.isIntegerRegisterOperand()||operand3.isImmediateOperand()||operand3.isMemoryOperand()))
	   	{
			
			if(operand2.getMemoryLocationSecondOperand()==null)
			{
				//If b is invalid operand, operand1 = a
				instructionArrayList.appendInstruction(Instruction.getStoreInstruction(operand1,operand3));
			}
			else
			{
				//operand1=a+b
		...
		{
			misc.Error.invalidOperation("Conditional Store", operand1, operand2, operand3);
		}
	}
}
