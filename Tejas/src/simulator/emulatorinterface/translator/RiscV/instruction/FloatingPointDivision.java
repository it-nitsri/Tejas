...
public class FloatingPointDivision implements RiscVStaticInstructionHandler 
{
					...
					throws InvalidInstructionException
	{
				...
				)
		{
			if(operand1.isMemoryOperand())
			{
				...
				instructionArrayList.appendInstruction(Instruction.getFloatingPointDivision(tempFloatRegister1, 
						operand3, operand1));
			}
			else
			{
				instructionArrayList.appendInstruction(Instruction.getFloatingPointDivision(operand2,
						operand3, operand1));
			}
		}
